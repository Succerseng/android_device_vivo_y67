...
ifeq ($(USE_F2FS_FORMAT_EXT4), true)
ifeq ($(FLASH_VERIFICATION_NAME),)
LOCAL_CFLAGS += -DPRODUCT_DEVICE=$(FLASH_VERIFICATION_NAME)
else
LOCAL_CFLAGS += -DPRODUCT_DEVICE=$(PRODUCT_DEVICE)
endif
LOCAL_CFLAGS += -DDEVICE_VIVO
endif
...
LOCAL_MODULE := local_binary
LOCAL_MODULE_PATH := $(TARGET_OUT)/recovery/root/sbin
