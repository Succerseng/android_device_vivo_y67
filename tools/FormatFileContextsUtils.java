 ...
 * 处理file_contexts文件
 */
class FormatFileContextsUtils {
    File file;

    public FormatFileContextsUtils(String file_contexts) {
    ...
    private static String[] checkPath(String[] paths) {
        ...
        try {
            for (String path : paths) {
                // send command
                Process process = Runtime.getRuntime().exec("adb shell if [ -e " + path + " ];then echo \"true\";else echo \"false\";fi");
